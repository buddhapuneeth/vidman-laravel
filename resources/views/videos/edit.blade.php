...
@section('content')
	...
	{!! Form::model($video, ['method' => 'patch', 'route' => ['videos.update', $video->slug], 'class' => 'form-horizontal']) !!}
    ...
    <div class="row" style="padding:10px">
        ...
        <center><div id="videoplayer" style="max-width:100%; height:auto; padding:10px;">
        	<video id="vid" controls><source src="/resources/videos/{{$video->vid_url}}" type="video/mp4" id="vid-src"> </video>
        </div></center>
    </div>
            </div>
            <div calss="col-xs-12" >
            <div class="panel panel-default" style="max-width:100%; width:750px; padding:10px; margin:auto;">
                <div class="panel-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            {!! Form::submit('edit', ['class'=>'cols-lg-4 col-lg-offset-2 btn btn-primary']) !!}
                        </div>
                    </fieldset>
                </div>
            </div>
